...
<div class="app" id="app">
    ...
    <div class="main-wrap">
        ...
        <main class="content">
            <div class="page active" id="pg-export">
                <div class="page-title-row">
                    ...
                    <div class="btn-row">
                        <a class="btn btn-primary" href="${pageContext.request.contextPath}/owner/export/list.do">
                            <span class="material-symbols-outlined" style="font-size:16px">list</span>
                            의뢰 목록
                        </a>
                        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/owner/export/form.do">
                ...
                <div id="export-list-view">
                    ...
                    <form method="get"
                        ...
                        <input type="text"
                               name="loadPortCd"
                               value="${searchDTO.loadPortCd}"
                               placeholder="선적항"
                               style="width:140px;padding:8px 10px;border:1px solid #e2e8f0;font-size:12px">

                        <input type="text"
                               name="arrvPortCd"
                               value="${searchDTO.arrvPortCd}"
                               placeholder="도착항"
                               style="width:140px;padding:8px 10px;border:1px solid #e2e8f0;font-size:12px">
                        ...
                        <a class="btn btn-primary"
                           href="${pageContext.request.contextPath}/owner/export/form.do"
                           style="padding:8px 18px;font-size:12px">
                            신규 의뢰
                        </a>
                    </form>
                        ...
                        <table class="data-table">
                            ...
                            <c:forEach items="${exportList}" var="expList">
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${expList.erStatusCd eq 'CSTM_SUPP_SUB'}">
                                        <c:set var="badgeClass" value="badge badge-cstm-supp-sub" />
                                        <c:set var="statusText" value="보완제출" />
                                    </c:when>

                                    <c:when test="${expList.erStatusCd eq 'CSTM_REJ'}">
                                        <c:set var="trStyle" value="background:#fff5f5" />
                                        <c:set var="idStyle" value="color:#991b1b" />
                                    ...
                                    <c:when test="${expList.erStatusCd eq 'CSTM_DONE'}">
                                        <c:set var="badgeClass" value="badge badge-cstm-done" />
                                        <c:set var="statusText" value="수리완료" />
                                    </c:when>

                                    <c:when test="${expList.erStatusCd eq 'CSTM_CANCEL'}">
                                ...
                                <tr style="${trStyle}">
                                    <td class="td-id" style="${idStyle}">${expList.erNo}</td>
                                    <td>${expList.erLoadPortCd} → ${expList.erArrvPortCd}</td>
                                    <td>${expList.brokerNm}</td>
                                    <td><span class="${badgeClass}">${statusText}</span></td>
                                    <td style="${dateStyle}">
                                        <fmt:formatDate value="${expList.erRqstDt}" pattern="yyyy-MM-dd"/>
                                    </td>
                                    <td>
                                        <a class="${btnClass}"
                                           href="${pageContext.request.contextPath}/owner/export/detail.do/${expList.erNo}">
                                                ${btnText}
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <div class="pagination"
                            ...
                            <c:if test="${searchDTO.prev}">
                                <c:url var="prevUrl" value="/owner/export/list.do">
                                    ...
                                    <c:param name="loadPortCd" value="${searchDTO.loadPortCd}" />
                                    <c:param name="arrvPortCd" value="${searchDTO.arrvPortCd}" />
                            ...
                            <c:forEach begin="${searchDTO.startPage}" end="${searchDTO.endPage}" var="p">
                                <c:url var="pageUrl" value="/owner/export/list.do">
                            ...
                            <c:if test="${searchDTO.next}">
                                <c:url var="nextUrl" value="/owner/export/list.do">
