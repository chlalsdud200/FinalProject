...
<%
  request.setAttribute("transportInitialGroup", "dashboard");
  request.setAttribute("transportInitialItem", "");
%>
<!DOCTYPE html>
...
<script src="${pageContext.request.contextPath}/resources/js/transport/pages/dash.js?v=20260604-dashboard-request-limit"></script>
</body>
</html>
