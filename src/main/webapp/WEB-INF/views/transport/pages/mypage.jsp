...
<%
    if (request.getAttribute("mypageActorPath") == null) {
        request.setAttribute("mypageActorPath", "transport");
    }
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/transport/pages/mypage.css">
</head>
...
<script>
  window.TRANSPORT_INITIAL_VIEW = { group: 'mypage', item: '${mypageTab eq 'alarm' ? 'TACS-MY-002' : 'TACS-MY-001'}' };
</script>
...
<script src="${pageContext.request.contextPath}/resources/js/transport/pages/mypage.js?v=20260512-mypage-shell1"></script>
</body>
</html>
