    ...
    <div class="main-wrap">
        ...
        <main class="content">
            <div class="breadcrumb">
                ...
                <span>결제</span>
                <span class="sep">›</span>
                <span class="current">영수증</span>
            </div>

            <div class="card-section pay-result-wrap">
                <div class="card-header">
                    <h3>
                        <c:out value="${paymentTitle}" default="결제" /> 영수증
                    </h3>
                </div>
                ...
                <div class="pay-result-body">
                    ...
                    <div class="pay-info-box">
                        <div class="pay-info-grid">
                            ...
                            <div class="pay-info-value">
                                <c:out value="${payRecord.oprPaymentId}" default="-" />
                            </div>

                            <div class="pay-info-label">결제수단</div>
                            <div class="pay-info-value">
                                <c:out value="${payRecord.oprPayMethodCd}" default="-" />
                            </div>

                            <div class="pay-info-label">결제상태</div>
                            <div class="pay-info-value success">
                                <c:if test="${payRecord.oprPayStatusCd eq 'PAY_DONE'}">결제완료</c:if>
                            </div>

                            <div class="pay-info-label">결제금액</div>
                            <div class="pay-info-value strong">
                                <fmt:formatNumber value="${payRecord.oprAmt}" pattern="#,###" /> 원
                            </div>

                            <div class="pay-info-label">승인일시</div>
                            <div class="pay-info-value">
                                <fmt:formatDate value="${payRecord.oprApprovedDt}" pattern="yyyy-MM-dd HH:mm:ss" />
                            </div>
                        </div>
                    </div>
